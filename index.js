...
/////////////////
const BotName = 'BELSC BOT☄'; 
const instagram = 'https://instagram.com/b3lsc.id'; 
const telegram = 'https://t.me/hironimusposen'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/c/b3lsc_id';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@b3lsc.id')
